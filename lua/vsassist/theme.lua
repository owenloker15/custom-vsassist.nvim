...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Structure', { fg = c.customRed, bg = 'NONE' })
    ...
    hl(0, '@constant.macro', { fg = c.customMacro, bg = 'NONE' })
    ...
    hl(0, '@property', { fg = c.customPink, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@conditional', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@repeat', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@label', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.customRed, bg = 'NONE' })
    hl(0, '@keyword.function', { fg = c.customRed, bg = 'NONE' })
    hl(0, '@keyword.operator', { fg = c.customRed, bg = 'NONE' })
    hl(0, '@operator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@exception', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@type', { fg = c.vsaGold, bg = 'NONE' })
    hl(0, '@type.builtin', { fg = c.customRed, bg = 'NONE' })
    ...
    hl(0, '@lsp.typemod.property', { link = '@property' })
    hl(0, '@lsp.type.macro', { fg = c.customMacro, bg = 'NONE' })
    hl(0, '@lsp.type.namespace', { link = '@structure' })
    hl(0, '@lsp.typemod.namespace.globalScope', { link = '@structure' })
    hl(0, '@lsp.typemod.namespace.defaultLibrary', { link = '@structure' })
